...
1) Create a new element in the HTML of the application

2) import ReactDOM inside the component

3) Call the ReactDOM.createPortal after return method

4) after the JSX, set one "," and acess the element that you have criated.

<img src="https://github.com/GustavoSouza12/React-Course/blob/main/React/prints/31_PortalDemo1.jpg"/>

<img src="https://github.com/GustavoSouza12/React-Course/blob/main/React/prints/31_PortalDemo2.jpg"/>
